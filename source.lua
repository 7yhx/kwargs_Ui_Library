...
local Themes = {
	...
	Jester = {
		Main = Color3.fromRGB(215, 121, 121),
		TabsBackground = Color3.fromRGB(202, 78, 78),
		ScrollBar = Color3.fromRGB(150, 150, 150),
		QuitText = Color3.fromRGB(225, 225, 225),

		TabDefault = Color3.fromRGB(200, 125, 125),
		...
		OptionDescription = Color3.fromRGB(215, 205, 205),
		...
		DropdownOptionsBackground = Color3.fromRGB(100, 50, 50),
		DropdownScrollbar = Color3.fromRGB(80, 30, 30),
		DropdownOption = Color3.fromRGB(100, 50, 50),
		DropdownText = Color3.fromRGB(255, 255, 255),
		DropdownOptionHover = Color3.fromRGB(125, 65, 65),
		DropdownOptionClick = Color3.fromRGB(130, 80, 80),

		ColourPickerBackground = Color3.fromRGB(130, 50, 50),

		BoxOutline = Color3.fromRGB(145, 125, 125),
		BoxHover = Color3.fromRGB(195, 175, 175),
